    ...
    <div className="space-y-6">
      ...
      <Card className="corp-surface">
        ...
        <CardContent className="space-y-4">
          ...
          {model.imageCatalog.length === 0 ? (
            <p className="corp-inline-warning">
              {labels.sections.instance.noImages}
            </p>
          ) : null}
          ...
          <form action={runSubmitProvisioning} className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                name="imageCode"
                className={SELECT_CLASS_NAME}
                disabled={isProvisioningFormLocked || model.imageCatalog.length === 0}
                required
                defaultValue={model.imageCatalog[0]?.code ?? ""}
              >
                {model.imageCatalog.length === 0 ? (
                  <option value="">{labels.sections.instance.noImages}</option>
                ) : null}
