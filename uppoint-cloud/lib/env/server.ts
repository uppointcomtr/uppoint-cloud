...
const serverEnvSchema = z.object({
  ...
  INSTANCE_ISO_UPLOAD_DIR: z.string().trim().min(1).default("/var/lib/uppoint-cloud/iso-uploads"),
  INSTANCE_ISO_UPLOAD_MAX_BYTES: z.coerce.number().int().min(1_048_576).max(107_374_182_400).default(12_884_901_888),
...
const parsedEnv = serverEnvSchema.safeParse({
  ...
  INSTANCE_ISO_UPLOAD_DIR: process.env.INSTANCE_ISO_UPLOAD_DIR,
  INSTANCE_ISO_UPLOAD_MAX_BYTES: process.env.INSTANCE_ISO_UPLOAD_MAX_BYTES,
